...
ISSUE_DATA = json.loads((ROOT / "docs/roadmap/issues.json").read_text())
...
PAGES: list[tuple[Path, Path, str | None, str | None]] = [
    ...
    *[(path, Path("spec") / path.name, None, None) for path in DOCS],
    (ROOT / "docs/roadmap/ISSUES.md", Path("roadmap/issues.md"), None, "The canonical milestone and implementation issue plan."),
    (ROOT / "docs/roadmap/dependency-graph.md", Path("roadmap/dependencies.md"), None, "The generated dependency graph across all canonical HUE issues."),
    (ROOT / "docs/decisions/0000-template.md", Path("decisions/adr-template.md"), "Architecture decision record template", "The evidence-first template for HUE architecture decisions."),
    (ROOT / "docs/decisions/0001-sveltekit-shadcn-svelte.md", Path("decisions/sveltekit-shadcn-svelte.md"), "ADR-0001 — SvelteKit + shadcn-svelte", "The accepted HUE frontend framework and component-foundation decision."),
    (ROOT / "docs/decisions/0002-bun-hermes-acp-workspace.md", Path("decisions/bun-hermes-acp-workspace.md"), "ADR-0002 — Bun + Hermes ACP workspace", "The accepted focused HUE workspace, storage, transport, and Hermes runtime boundary."),
    (ROOT / "docs/decisions/0004-project-development-panels.md", Path("decisions/project-development-panels.md"), "ADR-0004 — Project development panels", "The accepted Project-scoped terminal, Git, preview, file, and evidence boundary."),
    (ROOT / "docs/decisions/0006-hermes-projects-authority.md", Path("decisions/hermes-projects-authority.md"), "ADR-0006 — Hermes Projects authority", "The accepted Hermes Project identity and folder authority boundary."),
    (ROOT / "docs/decisions/0007-portable-pwa-cache-and-share-boundary.md", Path("decisions/portable-pwa-cache-and-share-boundary.md"), "ADR-0007 — Portable PWA cache and share boundary", "The accepted install, cache, launch-intent, and share boundary for HUE PWA."),
    (ROOT / "docs/decisions/0008-capacitor-android-native-shell.md", Path("decisions/capacitor-android-native-shell.md"), "ADR-0008 — Bounded Capacitor Android shell", "The accepted proof boundary for HUE Android transport and attention surfaces."),
...
for issue_id, issue in sorted(ISSUES_BY_ID.items()):
    source = ROOT / "docs/roadmap/issue-bodies" / f"{issue_id}.md"
...
ROUTES: dict[str, str] = {
    ...
    "docs/roadmap/ISSUES.md": "/roadmap/issues/",
    "docs/roadmap/dependency-graph.md": "/roadmap/dependencies/",
    "docs/decisions/0000-template.md": "/decisions/adr-template/",
    "docs/decisions/0001-sveltekit-shadcn-svelte.md": "/decisions/sveltekit-shadcn-svelte/",
    "docs/decisions/0002-bun-hermes-acp-workspace.md": "/decisions/bun-hermes-acp-workspace/",
    "docs/decisions/0004-project-development-panels.md": "/decisions/project-development-panels/",
    "docs/decisions/0006-hermes-projects-authority.md": "/decisions/hermes-projects-authority/",
    "docs/decisions/0007-portable-pwa-cache-and-share-boundary.md": "/decisions/portable-pwa-cache-and-share-boundary/",
    "docs/decisions/0008-capacitor-android-native-shell.md": "/decisions/capacitor-android-native-shell/",
    "prototype/README.md": "/prototype/component-map/",
    "CONTRIBUTING.md": "/contributing/",
    "docs/roadmap/issues.json": "/data/issues.json",
    "docs/roadmap/milestones.json": "/data/milestones.json",
    "docs/roadmap/labels.json": "/data/labels.json",
    "docs/roadmap/github-map.json": "/data/github-map.json",
}
for path in DOCS:
    ROUTES[path.relative_to(ROOT).as_posix()] = f"/spec/{path.stem}/"
for issue_id in ISSUES_BY_ID:
    ROUTES[f"docs/roadmap/issue-bodies/{issue_id}.md"] = f"/roadmap/issues/{issue_id.lower()}/"
...
def prepare_content() -> None:
    ...
    landing = APP / "site/content/index.mdx"
...
def prepare_public() -> None:
    ...
    prototype_app = PUBLIC / "prototype/app.js"
    prototype_app.write_text(prototype_app.read_text().replace("../docs/roadmap/ISSUES.md", "../roadmap/issues/"))

    data_dir = PUBLIC / "data"
    data_dir.mkdir(parents=True, exist_ok=True)
    for name in ("issues.json", "milestones.json", "labels.json", "github-map.json"):
        shutil.copy2(ROOT / "docs/roadmap" / name, data_dir / name)
