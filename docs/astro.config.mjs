      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Hermes Projects authority', slug: 'decisions/hermes-projects-authority' },
            { label: 'Portable PWA boundary', slug: 'decisions/portable-pwa-cache-and-share-boundary' },
            { label: 'Android shell proof', slug: 'decisions/capacitor-android-native-shell' },
