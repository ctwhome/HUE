...
export function normalizePreferences(value: unknown): HUEPreferences {
	...
	return {
		...
		limitChatWidth:
			typeof input.limitChatWidth === 'boolean'
				? input.limitChatWidth
				: defaultPreferences.limitChatWidth,
		language:
...
export function applyPreferences(root: HTMLElement, preferences: HUEPreferences) {
	...
	root.dataset.limitChatWidth = String(preferences.limitChatWidth);
